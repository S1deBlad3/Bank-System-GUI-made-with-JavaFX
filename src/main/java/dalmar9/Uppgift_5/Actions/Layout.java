...
import dalmar9.Uppgift_5.*;
import dalmar9.Uppgift_5.FileActions.*;
...
public class Layout {
    ...
    public Layout() {
        ...
        backToStart.setOnAction(e -> MainApplication.changeScene(MainApplication.window.getScene()));
        ...
        help.setOnAction(e -> VideoPlayer.display("Pepper song"));
        ...
        deleteAccount.setOnAction(e -> deleteFunctions.deleteAccount());

        MenuItem deleteCustomer = new MenuItem("Delete a customer");
        deleteCustomer.setOnAction(e -> deleteFunctions.deleteCustomer());
